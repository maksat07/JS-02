...
function t12() {
   ...
   let h= i121.value;
   let j= i122.value;
   console.log(i121.value);
   console.log(i122.value);
   out12.innerHTML= (g+" "+h+" "+j);
   i121.value=" ";
   i122.value=" ";
...
function t13() {
   ...
   let b= +i132.value;
   console.log(a+b);
   //console.log(i131.value);
   //console.log(i132.value);
   out13.innerHTML= a+b;
   i131.value=" ";
   i132.value=" ";
}
...
function t18() {
    ...
    document.querySelector('.out-18').innerHTML =parseFloat(t);
...
function t19() {
    let f = document.querySelector('.i-19-1').value;
    let w = document.querySelector('.i-19-2').value;
    document.querySelector('.out-19').innerHTML = - f - w;
}
